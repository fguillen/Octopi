...
namespace UnityCore {
    ...
    namespace Audio {
        ...
        public class AudioController : MonoBehaviour
        {
            ...
            public float _duration = 1.0f; //fade duration time
            public float _target = 1f; //target volume
...
#region Public Functions
            public void PlayAudio(AudioType _type, bool _fade=false, float _duration = 0.0f, float _target = 0.0f, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.START, _type, _fade, _duration, _target, _delay));
            }

            public void StopAudio(AudioType _type, bool _fade = false, float _duration = 0.0f, float _target = 0.0f, float _delay = 0.0F)
            {
                AddJob(new AudioJob(AudioAction.STOP, _type, _fade, _duration, _target, _delay));
            }

            public void RestartAudio(AudioType _type, bool _fade = false, float _duration = 0.0f, float _target = 0.0f, float _delay = 0.0F)
            {
                AddJob(new AudioJob(AudioAction.RESTART, _type, _fade, _duration, _target, _delay));
            }
#endregion
